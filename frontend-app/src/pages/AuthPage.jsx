        ...
        <div className={styles['overlay-container']}>
          <div className={styles.overlay}>
            <div className={`${styles['overlay-panel']} ${styles['overlay-left']}`}>
              ...
              {isSignUpActive && (
                <button className={`${styles.button} ${styles.ghost}`} onClick={() => setIsSignUpActive(false)}>Sign In</button>
              )}
            </div>
            <div className={`${styles['overlay-panel']} ${styles['overlay-right']}`}>
              ...
              {!isSignUpActive && (
                <button className={`${styles.button} ${styles.ghost}`} onClick={() => setIsSignUpActive(true)}>Sign Up</button>
              )}
            </div>
          </div>
        </div>
